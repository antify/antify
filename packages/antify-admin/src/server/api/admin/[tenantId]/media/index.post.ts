...
export default defineEventHandler(async (event) => {
    ...
    const form = formidable({ multiples: true, uploadDir: mediaStorage.getAbsoluteUploadDir(), keepExtensions: true });
    ...
    await Promise.all(Object.values(files).map((file: File) => {
