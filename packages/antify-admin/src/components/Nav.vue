...
const navItems = [
  {
    title: 'Dashboard',
    link: { name: 'backoffice-tenantId-dashboard' },
    icon: ['fa', 'house'],
  },
  {
    title: 'Benutzer',
    link: { name: 'backoffice-tenantId-users' },
    icon: ['fa', 'user'],
  },
  {
    title: 'Rollen',
    link: { name: 'backoffice-tenantId-roles' },
    icon: ['fa', 'user'],
  },
  {
    title: 'E-Mail Templates',
    link: { name: 'backoffice-tenantId-mail-templates' },
    icon: ['fa', 'user'],
  },
  {
    title: 'Mandanten',
    link: { name: 'backoffice-tenantId-tenants' },
    icon: ['fa', 'user'],
  },
];
const me = useMeState();
      ...
      <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
        ...
        <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
          ...
          <nav class="mt-5 px-2 space-y-1">
            ...
            <TenantLink
              :to="{ name: 'backoffice-tenantId-dashboard' }"
        ...
        <div class="flex-shrink-0 flex border-t border-gray-200 p-4">
          <TenantLink
            :to="{ name: 'backoffice-tenantId-profile' }"
