...
const me = useMeState();
const { data: userResponseData } = await useFetch(`/api/global/me`, useDefaultFetchOpts());
...
const { data: tennantsResponseData } = await useFetch(`/api/global/tenants`, useDefaultFetchOpts());
tenants.value = tennantsResponseData.value.default;
