...
(async () => {
  const {
    PrismaClient,
  } = require('../../node_modules/@internal/prisma/authClient/index.js');
  ...
  const bimbo = await prisma.user.create({
    data: userFixtures.createOne({
      id: '1039fc07-7be9-4dd4-b299-26addb875772',
      name: 'Bimbo Benutzer',
      // Password is: admin
      password:
        '3ba0469d6c4724298538beb08d2e3f5120df0f7670c2a4ff2874cf55fbda5f634661a0ca6a0d17cafc3e05fbe9d8ad868c32c2438bd2ba653c467ba55e4695a1',
      email: 'bimbo@bimbo.de',
      isSuperAdmin: false,
    }),
  });
