...
describe('Test tenants listing page', () => {
    ...
    it('Should show page correct', () => {
        ...
        cy.get('table > tbody > tr:first-child').should('have.text', 'Demo Mandant');
        cy.get('table > tbody > tr:first-child > td:first-child a').click();
        cy.location('pathname').should('eq', '/admin/1039fc07-7be9-4dd4-b299-26addb875111/tenants/1039fc07-7be9-4dd4-b299-26addb875111');
    });
});