...
import { dropDatabase } from '@antify/ant-database';
import { dropDatabaseMulti } from '@antify/ant-database';
import { MultiConnectionDropDatabaseCallbacks } from '@antify/ant-database';
import { DropDatabaseResult } from '@antify/ant-database';

export default defineAntDbCommand({
  meta: {
    name: 'drop-database',
    usage: 'ant-db drop-database [databaseName] [--tenant]',
